...
import { faEye, faEyeSlash, faEdit, faPlay, faPause, faUser, faList, faRightFromBracket, faCircle, faSquare, faArrowUpFromBracket} from '@fortawesome/free-solid-svg-icons'
